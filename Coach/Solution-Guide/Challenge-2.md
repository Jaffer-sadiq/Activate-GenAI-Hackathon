...
1. On **Add cognitive skills (Optional)** tab expand **Attach AI Services(1)**, within the section click on **Create new Azure AI service** to create Azure AI service resource.
   ...
   **Note:** This action will open a new tab to create the Azure AI services resource. Once the resource is created, go back to the previous tab and click **Refresh** to display the newly created resource name.
